    ...
    try:
        ...
        while not stop_event.is_set():
            try:
                ...
                # Correctly pass audio to the queue
...
async def transcribe_and_translate():
    ...
    while not stop_event.is_set():
        ...
        try:
            # Correctly use run_in_executor with both config and requests
            ...
            for response in responses:
                ...
                for result in response.results:
                    if result.is_final:
                        ...
                        # Create a new task to handle the translation and broadcast
...
async def main():
    ...
    # Correctly pass the loop to the audio stream thread
